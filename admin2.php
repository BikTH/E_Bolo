...
<body class="body2 text-light" id="top_page">
    ...
    <div id="wrapper">
        ...
        <?php include('views/admin2/sidebar_admin2.php'); ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content" class="body2 text-light">
                ...
                <!-- Topbar -->
                <!-- navbar de la page  -->
                <?php include('views/navbar/navbar_admin2.php') ?>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid ">  
                    ...
                    if (isset($_REQUEST["page"])) {
                        ...
                        include('views/admin2/home_admin2.php');
                    }
                    ?>
                </div>
            </div>
