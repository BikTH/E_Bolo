...
if (isset($_REQUEST['access_id1'])) {
    $access_id = $_REQUEST['access_id1'];
    $save = detail_of_access($access_id, $db);
    $data1 = detail_of_access($access_id, $db);
    $data2 = detail_of_access($access_id, $db);
    $data3 = detail_of_access($access_id, $db);
    require 'views/admin2/right_of_access/edit_template.php';
}
...
if (isset($_POST['submit_name'])) {
    ...
    if (check_access_name($data1['name'], $db) === 0 || check_access_name($data1['name'], $db) === 1) {
        ...
        if ($error === true) {
            ...
            update_access1($access_id, $data1, $db);
            $data2 = detail_of_access($access_id, $db);
            $data3 = detail_of_access($access_id, $db);
            require 'views/admin2/right_of_access/edit_template.php';
        }
...
if (isset($_POST['submit_module_back'])) {
    ...
    $data1 = $save;
    unset($_POST);
    unupdate_save_access1($save, $access_id, $db);
    require 'views/admin2/right_of_access/edit_template.php';
}
...
if (isset($_POST['submit_permission'])) {
    ...
    if ($error === true) {
        ...
        //die('<meta http-equiv="refresh" content="0 ; URL=admin2.php?page=views/admin2/right_of_access/list_of_access">');
    }
