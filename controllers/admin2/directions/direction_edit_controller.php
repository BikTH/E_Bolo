...
if (isset($_REQUEST['direction_id'])) {
    if (isset($_POST['submit_edit_direction'])) {
        ...
        if ($error == true) {
            require 'views/admin2/directions/edit_direction.php';
        } else {
            ...
            die('<meta http-equiv="refresh" content="0 ; URL=admin2.php?page=views/admin2/directions/list_directions&error_success='.$error_success.'">');
        }
    } else {
        $direction_id = $_REQUEST['direction_id'];
        $current_info = currentdirection_info($direction_id, $db);
        require 'views/admin2/directions/edit_direction.php';
        //die('<meta http-equiv="refresh" content="0 ; URL=admin2.php?page=views/admin2/directions/edit_direction">');
    }
}
