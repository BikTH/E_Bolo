...
if (isset($_POST['submit_skip_add_employee'])) {
    die('<meta http-equiv="refresh" content="0 ; URL=admin2.php?page=views/admin2/directions/list_directions">');
}
...
if (isset($_GET['add_employee'])) {
    ...
    require 'views/admin2/directions/add_direction2.php';
}

if (isset($_POST['submit_add_direction'])) {
    $error = false;
    ...
    if ($error == true) {
        require 'views/admin2/directions/add_direction.php';
    } else {
        $direction_id = create_directions($data, $db);
        $error_success = what_langauge() == 0 ? "Direction Créer avec succès !" : "Direction create with success !";
        require 'views/admin2/directions/add_direction2.php';
    }
}
...
if (isset($_POST['submit_name'])) {
    ...
    if (check_access_name($data1['name'], $db) === 0) {
        ...
        if (empty($data1['name']) || !is_string($data1['name']) || strlen($data1['name']) > 254) {
            $error = true;
            $error_content = what_langauge() == 0 ? "Nom incorect ou absent !" : "Incorrect or absent last name !";
            require 'views/admin2/directions/add_direction_11.php';
        } else {
    ...
    // require 'views/admin2/right_of_access/create_template';
    //die('<meta http-equiv="refresh" content="0 ; URL=admin2.php?page=views/admin2/right_of_access/create_template&case1=1&data1='.$data1['name'].'">');
}
...
if (isset($_POST['submit_permission'])) {
    ...
    if ($error === true) {
        ...
        die('<meta http-equiv="refresh" content="0 ; URL=admin2.php?page=views/admin2/directions/add_direction">');
    }
