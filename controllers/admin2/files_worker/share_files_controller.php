...
if(isset($_GET["file_id"])){
    ...
    require 'views/admin2/files_worker/share_file_to.php';
}
...
if(isset($_GET["share_file"])){
    ...
    die('<meta http-equiv="refresh" content="0 ; URL=admin2.php?page=views/admin2/files_worker/list_files&error_success=' . $error_success . '">');
