...
if(isset($_GET["file_id"])){
    ...
    require 'views/worker/files_worker/share_file_to.php';
}
...
if(isset($_GET["share_file"])){
    ...
    die('<meta http-equiv="refresh" content="0 ; URL=worker.php?page=views/worker/files_worker/list_files&error_success=' . $error_success . '">');
