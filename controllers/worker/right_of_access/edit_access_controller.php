...
if (isset($_REQUEST['access_id1'])) {
    ...
    require 'views/worker/right_of_access/edit_template.php';
}
...
if (isset($_POST['submit_name'])) {
    ...
    // require 'views/worker/right_of_access/create_template';
    //die('<meta http-equiv="refresh" content="0 ; URL=worker.php?page=views/worker/right_of_access/create_template&case1=1&data1='.$data1['name'].'">');
}
...
if (isset($_POST['submit_permission'])) {
    ...
    if ($error === true) {
        ...
        //die('<meta http-equiv="refresh" content="0 ; URL=worker.php?page=views/worker/right_of_access/list_of_access">');
    }
