        ...
        <div class="col-lg-8 order-lg-2">
            ...
            <div class="tab-content py-4">
                ...
                <div class="tab-pane" id="messages">
                    ...
                    <form class="user" enctype="multipart/form-data" method="post" action="admin3.php?page=controllers/admin3/user_information_controller">
                        <div class="text-right">
                            <h1 class="h6 text-Secondary-900 text-capitalize mb-1 mt-4">
                                <?php if (what_langauge() == 0) : ?>
                                    Informations Personelles
                            ...
                            <div class="tab-pane show active" id="mdp">
                                <div class="row">
                                    <div class="col-md-6 offset-md-3">
                                        ...
                                        <form class="user" method="post" action="admin3.php?page=controllers/admin3/user_information_controller">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
