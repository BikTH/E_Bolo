<div class="content m-5">
    <div class="row justify-content-center my-3">
        <h4 class="page-title"><?= language_content("Nom de la Direction: \"", "Direction's name: \"") ?><?= $list["directionName"] . "\"" ?> </h4>
    </div>
    <hr class="text-light">
    <hr class="text-light">
    <div class="row justify-content-center">
        <div class="col-6 text-center">
            <a href="admin3.php?page=controllers/admin3/directions/direction_edit_controller&direction_id=<?= $list['directionId'] ?>" class="btn btn-success btn-sm "> <?php language_content("Modifier ", "Edit ") ?> <i class="fas fa-fw fa-pen"></i> </a>
        </div>
        <div class="col-6 text-center">
            <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_direction"><i class="fas fa-fw fa-trash"></i> <?php language_content("Supprimer", "Delete") ?></a>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-gradient-dark">
                        ...
                        <div class="modal-footer m-auto">
                            ...
                            <a class="btn btn-danger" href="admin3.php?page=controllers/admin3/directions/delete_direction_controller&direction_id=<?= $list["directionId"] ?>&direction_user=<?= $list["directionAdmin"] ?>"><?php language_content("Supprimer", "Delete") ?></a>
                        </div>
                    </div>
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 col-xl-12">
            <div class="table-responsive mt-3">
                <table class="table table-striped" width="100%" cellspacing="0">
                    <thead>
                        <!-- <a href="admin3.php?page=views/admin3/directions/add_employee_to_direction&direction_id=<?= $list['directionId'] ?>" class=" rounded-left btn btn-danger btn-sm"><i class="fas fa-fw fa-backspace"></i> <?php language_content("  Retirer ", "  Retrieve ") ?> </a>
                        <a href="admin3.php?page=views/admin3/directions/add_employee_to_direction&add_employee&direction_id=<?= $list['directionId'] ?>" class=" rounded-right btn btn-info btn-sm"><?php language_content(" Ajouter  ", " Add  ") ?><i class="fas fa-fw fa-plus-circle"></i> </a> -->
                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tfoot>
                        <tr class="text-center">
                            <td colspan="4">
                                <a href="admin3.php?page=views/admin3/directions/add_employee_to_direction&add_employee&direction_id=<?= $list['directionId'] ?>" class=" btn btn-secondary text-light col-md-4"><?php language_content(" Ajouter  ", " Add  ") ?><i class="fas fa-fw fa-plus-circle"></i> </a>
                            </td>
                        </tr>
                    </tfoot>
                    <tbody>
