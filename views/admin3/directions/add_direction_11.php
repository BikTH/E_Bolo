<div class="content mt-2">
    ...
    <div class="row">
        <div class="col-sm-5 col-md-5 col-lg-5 col-xl-4">
            <form class="form user" enctype="multipart/form-data" method="post" action="admin3.php?page=controllers/admin3/directions/add_direction_controller">
                <fieldset <?php
                            if (isset($case1)) {
                                echo "disabled";
                            } ?>>
        ...
        <div class="col-sm-7 col-md-7 col-lg-7 col-xl-8">
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade mx-5 my-2 show<?php if (isset($case1)) : ?> active<?php endif; ?>" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <form class="mb-5" enctype="multipart/form-data" method="post" action="admin3.php?page=controllers/admin3/directions/add_direction_controller&access_id=<?= $access_id ?>">
