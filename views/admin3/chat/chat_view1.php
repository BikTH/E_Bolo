        ...
        <div class="col-md-4 col-xl-3 chat">
            <div class="card mb-sm-3 mb-md-0 contacts_card bg-transparent">
                <div class="card-header bg-gradient-dark text-center">
                    <div>
                        <a href="admin3.php?page=controllers/admin3/chat/create_chat_controller" class="btn-outline-dark text-light btn-block rounded "> <i class="fa fa-plus-circle"></i> <?= language_content(" Nouvelle discution", " New discusion") ?> </a>
                    </div>
                ...
                <div class="card-body contacts_body">
                    <ui class="contacts">
                        ...
                        ?>
                                <li class="">
                                    <a href="admin3.php?page=controllers/admin3/chat/message-detail-controller&user_id=<?= $user['userId'] ?>" class="text-light ">
            ...
            <div class="col-md-8 col-xl-6 chat">
                <div class="card bg-transparent shadow ">
                                        ...
                                        <div class="msg_cotainer text-light">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-8">
                                                            <a class="btn btn-outline-success" href="admin3.php?page=controllers/admin3/chat/save_msg_file_controller&user_id=<?= $user_detail["userId"] ?>&file_id=<?= $info2["fileId"] ?>">
                    ...
                    <div class="card-footer bg-gradient-dark">
                        ...
                        <form method="post" action="admin3.php?page=controllers/admin3/chat/add-message-controller">
                            <div class="input-group">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr class="text-light">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <a href="admin3.php?page=controllers/admin3/chat/send_file_controller&fileid=<?= $file["fileId"] ?>&userid=<?= $user_detail['userId'] ?>" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="text-light">
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-outiline-info btn-sm" href="admin3.php?page=controllers/admin3/chat/create_chat_controller&userid=<?= $user2["userId"] ?>">
