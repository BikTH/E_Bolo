    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col-6 row justify-content-end">
                <?php if ($test["e3"] == 1) : ?>
                    <a href="admin3.php?page=views/admin3/employees/add_employee" class="btn btn-info btn-sm float-right"><i class="fas fa-fw fa-plus-circle"></i><?php language_content("Ajouter un employé", "Add Employee") ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
                                        ...
                                        <div id="add_direction<?= $compt ?>" class="modal fade delete-modal" role="dialog">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content bg-gradient-dark">
                                                    ...
                                                    <form method="post" action="admin3.php?page=controllers/admin3/employees/assign_employee_to_direction_controller">
                                                        <div class="row m-4">
                                        ...
                                        <div id="del_direction<?= $compt ?>" class="modal fade delete-modal" role="dialog">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content bg-gradient-dark">
                                                    ...
                                                    <div class="modal-footer m-auto">
                                                        <button class="btn btn-secondary" type="button" data-dismiss="modal"><?php language_content("Annuler", "Cancel") ?></button>
                                                        <a class="btn btn-danger" href="admin3.php?page=controllers\admin3\employees\remove_employee_direction_controller&user_id=<?= $list['userId'] ?>"><?php language_content("Retirer", "Retrieve") ?></a>
                                                    </div>
                                                </div>
                                    ...
                                    <div id="change_accesss<?= $compt ?>" class="modal fade delete-modal" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content bg-gradient-dark">
                                                ...
                                                <form method="post" action="admin3.php?page=controllers/admin3/employees/change_employee_access_controller">
                                                    <div class="row m-4">
                                                        <div class="modal-body text-center">
                                                            <div class="row mb-5 ">
                                                                <div class="col-sm-12">
                                    ...
                                    <div id="block_user<?= $compt ?>" class="modal fade delete-modal" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content bg-gradient-dark">
                                                ...
                                                <div class="modal-footer m-auto">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal"><?php language_content("Annuler", "Cancel") ?></button>
                                                    <a class="btn btn-danger" href="admin3.php?page=controllers/admin3/employees/block_employee_controller&user_id=<?= $list["userId"] ?>"><?php language_content("Bloquer", "Block") ?></a>
                                                </div>
                                            </div>
                ...
                <div class="col-md-4 col-sm-4 col-lg-3">
                    ...
                    <div class="profile-widget bg-gradient-dark">
                        <div class="doctor-img">
                            <a class="avatar" href="admin3.php?page=controllers/admin3/employees/details_employee_controller&user_id=<?= $list["userId"] ?>"> <img alt="" src="<?= user_avatar_by_id2($list, $db) ?>"> </a>
                        </div>
                        ...
                        <a class="text-light text-decoration-none" href="admin3.php?page=controllers/admin3/employees/details_employee_controller&user_id=<?= $list["userId"] ?>">
        ...
        <div class="card bg-dark shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    ...
                    <div class="col-6 row justify-content-end">
                        <a href="admin3.php?page=views/admin3/employees/add_employee" class="btn btn-info btn-sm float-right"> <i class="fas fa-plus-circle"></i><?php language_content("Ajouter un employé", "Add an Employee") ?></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="text-light">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="admin3.php?page=controllers/admin3/employees/details_employee_controller&user_id=<?= $list['userId'] ?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i> <?php language_content("Détails", "Détails") ?></a>
