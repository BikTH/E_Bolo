                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="text-light">
                                ...
                                <td class="text-center">
                                    <a href="admin3.php?page=controllers/admin3/directions/add_employee_to_direction_controller&direction=<?= $_SESSION["user_direction"] ?>&employee=<?= $list["userId"] ?>" class="btn btn-danger"><i class="fas fa-fw fa-backspace"></i><?php language_content(" Retirer", " Retrieve") ?></button>
                                        <?php if ($_SESSION["user_id"] != $list["userId"]) : ?>
                                            <a href="admin3.php?page=controllers/admin3/chat/message-detail-controller&user_id=<?=$list["userId"] ?>" class="btn btn-info"><?= language_content("Ecrire ","Write ")?><i class="fas fa-fw fa-comments"></i></a>
                                        <?php endif; ?>
                                </td>
                            </tr>
                        <?php endwhile; ?>
