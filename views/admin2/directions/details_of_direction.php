<div class="content m-5">
    ...
    <div class="row justify-content-center">
        <div class="col-6 text-center">
            <a href="admin2.php?page=controllers/admin2/directions/direction_edit_controller&direction_id=<?= $list['directionId'] ?>" class="btn btn-success btn-sm "> <?php language_content("Modifier ", "Edit ") ?> <i class="fas fa-fw fa-pen"></i> </a>
        </div>
        <div class="col-6 text-center">
