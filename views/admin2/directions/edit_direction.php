...
<div class="row justify-content-center py-4 mx-0">
    ...
    <div class=" offset-1 col-10">
        <div class="card card-body bg-transparent shadow-sm border-0">
            <form enctype="multipart/form-data" method="post" action="admin2.php?page=controllers/admin2/directions/direction_edit_controller&direction_id=<?=$direction_id?>" class="needs-validation" novalidate>
