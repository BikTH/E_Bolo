<div class="content mt-2">
    ...
    <div class="row">
        <div class="col-sm-5 col-md-5 col-lg-5 col-xl-4">
            <form class="form user" enctype="multipart/form-data" method="post" action="admin2.php?page=controllers/admin2/right_of_access/edit_access_controller&access_id=<?= $access_id ?>">
                <fieldset>
                    <legend> </legend>
        ...
        <div class="col-sm-7 col-md-7 col-lg-7 col-xl-8">
            ...
            <form class="mb-5" enctype="multipart/form-data" method="post" action="admin2.php?page=controllers/admin2/right_of_access/edit_access_controller&access_id=<?= $access_id ?>">
    ...
    <div class="row justify-content-center mt-3">
        ...
        <div class="col-12 mt-0 text-center">
            <a class="btn bt btn-rounded btn-success" href="admin2.php?page=views/admin2/right_of_access/list_of_access&error_success=<?= language_content("Modèle édité avec succès !","Template Edited with success !") ?>">
