<div class="content m-5">
    ...
    <div class="row justify-content-center">
        <div class="col-6 text-center">
            <a class=" btn btn-block btn-outline-inverse rounded" href="admin2.php?page=controllers/admin2/right_of_access/edit_access_controller&access_id1=<?= $list["access_id"] ?>"> <i class="fas fa-pen text-info"> <?= language_content(" Modifier modèle", " Edit template") ?> </i> </a>
        </div>
        <div class="col-6 text-center">
