    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col-6 row justify-content-end">
                <a href="admin2.php?page=views/admin2/files_worker/upload_files" class="btn btn-info btn-sm float-right"><i class="fas fa-fw fa-upload"></i><?php language_content("Mettre en ligne un fichier", "Upload a file") ?></a>
            </div>
        </div>
    </div>
    <div class="card-body">
                        ...
                        <tr class="text-light ">
                            ...
                            <td class="" scope="row">
                                ...
                                <?php if (name_of_type($info->getExtension()) == "PDF" || name_of_type($info->getExtension()) == "IMAGE") : ?>
                                    <a href="admin2.php?page=controllers\admin2\files_worker\preview_file_controller&file_id=<?= $list['fileId'] ?>" class="btn btn-light btn-sm float-right"> <i class="fas fa-fw fa-eye"></i></a>
                                <?php endif; ?>
                            ...
                            <td class="text-center">
                                <div class=" btn-lg btn-group">
                                    <a href="admin2.php?page=controllers/admin2/files_worker/edit_files_controller&file_id=<?= $list['fileId'] ?>" class="btn btn-outline-info "> <i class="fas fa-fw fa-pen"></i></a> 
                                    <a href="<?= $list["filePosition"] ?>" download class="btn btn-outline-warning "> <i class="fas fa-fw fa-download"></i> </a>
                                    <a href="admin2.php?page=controllers/admin2/files_worker/share_files_controller&file_id=<?= $list['fileId'] ?>" class="btn btn-outline-success text-success"> <i class="fas fa-fw fa-share-alt"></i> </a>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content bg-gradient-dark">
                                    ...
                                    <div class="modal-footer m-auto">
                                        ...
                                        <a class="btn btn-danger" href="admin2.php?page=controllers/admin2/files_worker/delete_files_controller&file_id=<?= $list["fileId"] ?>"><?php language_content("Supprimer", "Delete") ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
