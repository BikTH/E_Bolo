...
<div class="row justify-content-center py-4 mx-0">
    ...
    <div class=" offset-1 col-10"> 
        <div class="card card-body bg-transparent border-0 shadow-sm">
            <form enctype="multipart/form-data" method="post" action="admin2.php?page=controllers\admin2\files_worker\edit_files_controller" class="needs-validation" novalidate>
