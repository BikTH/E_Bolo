                        ...
                        <tr class="text-light">
                            ...
                            <td class="" scope="row">
                                ...
                                <?php if (name_of_type($info->getExtension()) == "PDF" || name_of_type($info->getExtension()) == "IMAGE") : ?>
                                    <a href="admin2.php?page=controllers\admin2\files_worker\preview_file_controller&file_id=<?= $list['fileId'] ?>" class="btn btn-outline-light btn-sm float-right"> <i class="fas fa-fw fa-eye"></i></a>
                                <?php endif; ?>
