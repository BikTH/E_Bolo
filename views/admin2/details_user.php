                ...
                <div class="tab-pane active" id="profile">
                    <form class="user" method="post">
                        ...
                        <div class=" form-group row ">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 mb-sm-0">
                                    <a href="admin2.php?page=controllers/admin2/activate_user_controller&User_Id=<?= $list['userId'] ?>" class="btn btn-user btn-block btn-outline-success text-success"> <i class="fas fa-fw fa-check-square"></i><?php language_content(" Activer", " Activate") ?></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-8 order-lg-2">
            <form class="user" method="post">
                ...
                <div class=" form-group row ">
                    <div class="col-sm-6">
                        <div class="mb-3 mb-sm-0">
                            <a href="admin2.php?page=controllers/admin2/block_user_controller&User_Id=<?= $list['userId'] ?>" class="btn btn-user btn-block btn-outline-danger text-light"> <i class="fas fa-trash-alt text-danger"></i><?php language_content(" Bloquer", " Activer") ?></a>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-3 mb-sm-0">
