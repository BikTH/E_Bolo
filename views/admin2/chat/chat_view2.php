...
<div class="container-fluid h-100 mt-5" style="size: cover;">
    <div class="row justify-content-center h-100">
        <div class="col-md-4 col-xl-3 chat">
            <div class="card mb-sm-3 mb-md-0 contacts_card bg-transparent">
                <div class="card-header bg-gradient-dark text-center">
                    <div>
                        <a href="admin2.php?page=controllers/admin2/chat/create_chat_controller2" class="btn-outline-dark text-light btn-block rounded "> <i class="fa fa-plus-circle"></i> <?= language_content("Nouveau Groupe", "New group") ?> </a>
                    </div>
                ...
                <div class="card-body contacts_body">
                    <ui class="contacts">
                        ...
                        ?>
                                <li class="">
                                    <a href="admin2.php?page=controllers/admin2/chat/message-detail-controller2&user_id=<?= $user['userId'] ?>" class="text-light ">
            ...
            <div class="col-md-8 col-xl-6 chat">
                <div class="card bg-transparent shadow ">
                                        ...
                                        <div class="msg_cotainer text-light">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-8">
                                                            <a class="btn btn-outline-success" href="admin2.php?page=controllers/admin2/chat/save_msg_file_controller2&user_id=<?= $user_detail["userId"] ?>&file_id=<?= $info2["fileId"] ?>">
                                                                <i class="fa fa-save"></i> Enregistrer
                                                            </a>
                                                        </div>
                                                        <div class="col-4">
                                                            <a class="btn btn-outline-info" href="admin2.php?page=controllers/admin2/files_worker/preview_file_controller&file_id=<?= $info2["fileId"] ?>">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row m-1">
                                                <div class="col-8">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto">
                                                            <a class="btn btn-outline-light" href="admin2.php?page=controllers/admin2/files_worker/preview_file_controller&file_id=<?= $info2["fileId"] ?>">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                    ...
                    <div class="card-footer bg-gradient-dark">
                        ...
                        <form method="post" action="admin2.php?page=controllers/admin2/chat/add-message-controller2">
                            <div class="input-group">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr class="text-light">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <a href="admin2.php?page=controllers/admin2/chat/send_file_controller2&fileid=<?= $file["fileId"] ?>&userid=<?= $user_detail['userId'] ?>" class="btn btn-primary btn-sm">
        ...
        <?php else : ?>
            <?php if (isset($new_conversation1)) : ?>
                <div class="col-md-8 col-xl-6 chat">
                    <div class="card rounded bg-transparent border-0">
                        <form enctype="multipart/form-data" method="post" action="admin2.php?page=controllers/admin2/chat/create_chat_controller2" class="needs-validation m-4" novalidate>
                            <div class="text-center my-4">
                                <span class="h3 font-weight-bold text-light"><?= language_content("Informations du Groupe", "Group's informations") ?></span>
                            </div>
                            <div class="row mt-4 mb-0">
                                <div class="form-group col">
                                    <label for="exampleInputEmail1"><?= language_content("Nom du groupe", "Group's name") ?></label>
                                    <input required type="text" name="name" class="form-control bg-dark text-info " required id="exampleInputEmail1" value="<?= $data['name'] ?? '' ?>" aria-describedby="">
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <button type="submit" name="submit" class="btn btn-outline-info col-md-4"><?= language_content("Suivant", "Next") ?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php endif; ?>
            <?php if (isset($new_conversation2)) : ?>
                <div class="col-md-8 col-xl-6 chat">
                    <div class="card rounded bg-transparent border-0">
                        <div class="text-center my-4">
                            <span class="h3 font-weight-bold text-light"><?= language_content("Ajouter des membres", "add participants") ?></span>
                        </div>
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="text-light">
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-outiline-info btn-sm" href="admin2.php?page=controllers/admin2/chat/create_chat_controller2&group_id=<?= $groupId?>&userid=<?= $user2["userId"] ?>">
                                                    <i class="fas fa-2x fw fa-plus-circle"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php $compt += 1;
            ...
            <?php endif;
            if (isset($new_conversation1) || isset($new_conversation2)) : ?>
                ...
                <div class="col-md-8 col-xl-6 chat">
                    <div class="card rounded bg-transparent border-0">
                        <div class="bg-transparent border-0 text-center text-light " style="padding-top: 180px">
                            <h1><?= language_content("Mes Groupes", "My Groups") ?></h1>
                            <h3><?= language_content("Veuillez choisir une conversation de groupe ou créez un nouveau groupe", "Choose a group's conversation to begin or create new one") ?></h2>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
