                            ...
                            <div class="card-body justify-content-center p-0">
                                ...
                                <h2 class="h1-responsive font-weight-bold text-center my-4">
                                    <?php if (what_langauge() == 0) : ?>
                                        Vous avez des suggestion à faire à propos de notre plateforme ? Ecrivez nous !
                                    <?php else : ?>
                                        You have any suggestion about our plateform ? Write us
                                    <?php endif; ?>
                                </h2>
                                                ...
                                                <fieldset disabled>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-2">
                                                            ...
                                                            <input value='<?= $_SESSION["user_name"] . " " . $_SESSION["user_prename"] ?>'' type="text" id="name" name="name" class="form-control form-control-user bg-dark text-light" required>
                                                        </div>
                                                        <div class="col-md-6 mb-md-2">
                                                            ...
                                                            <input value="<?= $_SESSION["user_email"] ?>" type="text" id="email" name="email" class="form-control form-control-user bg-dark text-light" required>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                                <div class="row my-2">
