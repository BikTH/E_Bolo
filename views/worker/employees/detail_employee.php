<div class="content m-5">
    ...
    <div class="row justify-content-center">
        <div class="col-6 text-center">
            <a href="worker.php?page=controllers/worker/directions/direction_edit_controller&direction_id=<?= $list['directionId'] ?>" class="btn btn-outline-success btn-sm text-success"> <?php language_content("Modifier ", "Edit ") ?> <i class="fas fa-fw fa-pen"></i> </a>
        </div>
        <div class="col-6 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-gradient-dark">
                        ...
                        <div class="modal-footer m-auto">
                            ...
                            <a class="btn btn-danger" href="worker.php?page=controllers/worker/directions/delete_direction_controller&direction_id=<?= $list["directionId"] ?>&direction_user=<?= $list["directionAdmin"] ?>"><?php language_content("Supprimer", "Delete") ?></a>
                        </div>
                    </div>
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 col-xl-12">
            <div class="table-responsive mt-3">
                <table class="table table-striped" width="100%" cellspacing="0">
                    <thead>
                        <!-- <a href="worker.php?page=views/worker/directions/add_employee_to_direction&direction_id=<?= $list['directionId'] ?>" class=" rounded-left btn btn-outline-danger btn-sm"><i class="fas fa-fw fa-backspace"></i> <?php language_content("  Retirer ", "  Retrieve ") ?> </a>
                        <a href="worker.php?page=views/worker/directions/add_employee_to_direction&add_employee&direction_id=<?= $list['directionId'] ?>" class=" rounded-right btn btn-outline-info btn-sm"><?php language_content(" Ajouter  ", " Add  ") ?><i class="fas fa-fw fa-plus-circle"></i> </a> -->
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="text-info">
                                ...
                                <td class="text-center">
                                    <a href="worker.php?page=controllers/worker/directions/add_employee_to_direction_controller&direction=<?= $direction_id ?>&employee=<?= $list["userId"] ?>" class="btn btn-danger col-md-4"><i class="fas fa-fw fa-backspace"></i><?php language_content(" Retirer", " Retrieve") ?></button>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
