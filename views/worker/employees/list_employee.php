    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col-6 row justify-content-end">
                <?php if ($test["e3"] == 1) : ?>
                    <a href="worker.php?page=views/worker/employees/add_employee" class="btn btn-info btn-sm float-right"><i class="fas fa-fw fa-plus-circle"></i><?php language_content("Ajouter un employé", "Add Employee") ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
                        ...
                        <tr class="text-light">
                                        ...
                                        <div id="add_direction<?= $compt ?>" class="modal fade delete-modal" role="dialog">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content bg-gradient-dark">
                                                    ...
                                                    <form method="post" action="worker.php?page=controllers/worker/employees/assign_employee_to_direction_controller">
                                                        <div class="row m-4">
                                        ...
                                        <div id="del_direction<?= $compt ?>" class="modal fade delete-modal" role="dialog">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content bg-gradient-dark">
                                                    ...
                                                    <div class="modal-footer m-auto">
                                                        <button class="btn btn-secondary" type="button" data-dismiss="modal"><?php language_content("Annuler", "Cancel") ?></button>
                                                        <a class="btn btn-danger" href="worker.php?page=controllers\worker\employees\remove_employee_direction_controller&user_id=<?= $list['userId'] ?>"><?php language_content("Retirer", "Retrieve") ?></a>
                                                    </div>
                                                </div>
                            ...
                            <td class="align-middle">
                                ...
                                <div class="float-right">
                                    <?php $list["isAdmin"] == 1 ? ($_SESSION["user_id"] == $list["companyAdmin"] ? ($list["userId"] == $list["companyAdmin"] ? '' : ($test["e2"] != 1 ? '' : print("<a data-toggle=\"modal\" data-target=\"#change_accesss" . $compt . "\"href=\"#\" class=\"btn btn-info btn-sm\"> <i class=\"fas fa-fw fa-pen\"></i> </a>")))  : '') : ($test["e2"] != 1 ? '' : print("<a data-toggle=\"modal\" data-target=\"#change_accesss" . $compt . "\"href=\"#\" class=\"btn btn-info btn-sm\"> <i class=\"fas fa-fw fa-pen\"></i> </a>"))  ?>
                                    <div id="change_accesss<?= $compt ?>" class="modal fade delete-modal" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content bg-gradient-dark">
                                                ...
                                                <form method="post" action="worker.php?page=controllers/worker/employees/change_employee_access_controller">
                                                    <div class="row m-4">
                                                        <div class="modal-body text-center">
                                                            <div class="row mb-5 ">
                                                                <div class="col-sm-12">
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <?php if ($_SESSION["user_id"] != $list["userId"]) : ?>
                                        <a href="" worker.php?page=controllers/worker/chat/message-detail-controller&user_id=<?= $list["userId"] ?>"" class="btn btn-info btn-sm"><i class="fas fa-fw fa-comments"></i></a>
                                    <?php endif; ?>
                                    ...
                                    <div id="block_user<?= $compt ?>" class="modal fade delete-modal" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content bg-gradient-dark">
                                                ...
                                                <div class="modal-footer m-auto">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal"><?php language_content("Annuler", "Cancel") ?></button>
                                                    <a class="btn btn-danger" href="worker.php?page=controllers/worker/employees/block_employee_controller&user_id=<?= $list["userId"] ?>"><?php language_content("Bloquer", "Block") ?></a>
                                                </div>
                                            </div>
...
<div class="tab-content my-3" id="nav-tabContent">
    ...
    <!-- <div class="tab-pane fade" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        ...
        <div class="row">
            ...
            while ($list = mysqli_fetch_assoc($lists)) :
            ?>
                <?php include('views/worker/modals_worker.php'); ?>
                <div class="col-md-4 col-sm-4 col-lg-3">

                    <div class="profile-widget bg-gradient-dark">
                        <div class="doctor-img">
                            <a class="avatar" href="worker.php?page=controllers/worker/employees/details_employee_controller&user_id=<?= $list["userId"] ?>"> <img alt="" src="<?= user_avatar_by_id2($list, $db) ?>"> </a>
                        </div>
                        ...
                        <a class="text-light text-decoration-none" href="worker.php?page=controllers/worker/employees/details_employee_controller&user_id=<?= $list["userId"] ?>">
        ...
        <div class="card bg-dark shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    ...
                    <div class="col-6 row justify-content-end">
                        <a href="worker.php?page=views/worker/employees/add_employee" class="btn btn-info btn-sm float-right"> <i class="fas fa-plus-circle"></i><?php language_content("Ajouter un employé", "Add an Employee") ?></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="text-light">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="worker.php?page=controllers/worker/employees/details_employee_controller&user_id=<?= $list['userId'] ?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i> <?php language_content("Détails", "Détails") ?></a>
