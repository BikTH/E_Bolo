    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col-6 row justify-content-end">
                <a href="worker.php?page=views/worker/files_worker/upload_files" class="btn btn-info btn-sm float-right"><i class="fas fa-fw fa-upload"></i><?php language_content("Mettre en ligne un fichier", "Upload a file") ?></a>
            </div>
        </div>
    </div>
    <div class="card-body">
                        ...
                        <tr class="text-light ">
                            ...
                            <td class="text-center">
                                <div class=" btn-lg btn-group">
                                    <a href="worker.php?page=controllers/worker/files_worker/edit_files_controller&file_id=<?= $list['fileId'] ?>" class="btn btn-outline-info "> <i class="fas fa-fw fa-pen"></i></a> 
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content bg-gradient-dark">
                                    ...
                                    <div class="modal-footer m-auto">
                                        ...
                                        <a class="btn btn-danger" href="worker.php?page=controllers/worker/files_worker/delete_files_controller&file_id=<?= $list["fileId"] ?>"><?php language_content("Supprimer", "Delete") ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
