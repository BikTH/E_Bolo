                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tfoot>
                        <tr class="text-center">
                            <td colspan="4">
                                <a class="btn btn-secondary text-light col-md-4" href="worker.php?page=views/worker/files_worker/list_files"><?php language_content("Terminer ", "Close ") ?><i class="fas fa-fw fa-arrow-circle-right"></i></a>
                            </td>
                        </tr>
                    </tfoot>
                    <tbody>
                        ...
                        ?>
                            <tr class="text-light">
                                ...
                                <td class="text-center">
                                    <a href="worker.php?page=controllers/worker/files_worker/share_files_controller&share_file&file_id2=<?= $file_id ?>&receiver=<?= $list["userId"] ?>" class="btn btn-success col-md-4"><i class="fas fa-fw fa-location-arrow"></i></button>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
