    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col-6 row justify-content-end">
                <?php if ($test["f3"] == 1) : ?>
                    <a href="worker.php?page=views/worker/company_files/upload_files" class="btn btn-info btn-sm float-right"><i class="fas fa-fw fa-upload"></i><?php language_content("Mettre en ligne un fichier", "Upload a file") ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
                        ...
                        <tr class="text-light ">
                            ...
                            <td class="" scope="row">
                                ...
                                <?php if (name_of_type($info->getExtension()) == "PDF" || name_of_type($info->getExtension()) == "IMAGE") : ?>
                                    <?php if ($test["f1"] == 1) : ?>
                                        <a href="worker.php?page=controllers\worker\company_files\preview_file_controller&file_id=<?= $list['fileId'] ?>" class="btn btn-light btn-sm float-right"> <i class="fas fa-fw fa-eye"></i></a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            ...
                            <td class="text-center">
                                <div class=" btn-lg ">
                                    <!-- <a href="worker.php?page=controllers/worker/company_files/edit_files_controller&file_id=<?= $list['fileId'] ?>" class="btn btn-info "> <i class="fas fa-fw fa-pen"></i></a> -->
                                    <?php if ($test["f1"] == 1) : ?>
                                        <a href="<?= $list["filePosition"] ?>" download class="btn btn-warning "> <i class="fas fa-fw fa-download"></i> </a>
                                        <a href="worker.php?page=controllers/worker/company_files/share_files_controller&file_id=<?= $list['fileId'] ?>" class="btn btn-outline-success text-success"> <i class="fas fa-fw fa-share-alt"></i> </a>
                                    <?php endif; ?>
                                    <?php if ($test["f4"] == 1) : ?>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content bg-gradient-dark">
                                    ...
                                    <div class="modal-footer m-auto">
                                        ...
                                        <a class="btn btn-danger" href="worker.php?page=controllers/worker/company_files/delete_files_controller&file_id=<?= $list["fileId"] ?>"><?php language_content("Supprimer", "Delete") ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
