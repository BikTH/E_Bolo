                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-gradient-dark">
                      ...
                      <div class="modal-footer m-auto">
                        ...
                        <a class="btn btn-info" href="worker.php?page=controllers/worker/activate_user_controller&User_Id=<?= $list['userId'] ?>"><?php language_content("Activer", "Activate") ?></a>
                      </div>
                    </div>
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-gradient-dark">
                      ...
                      <div class="modal-footer m-auto">
                        ...
                        <a class="btn btn-danger" href="worker.php?page=controllers/worker/block_user_controller&User_Id=<?= $list['userId'] ?>"><?php language_content("Supprimer", "Delete") ?></a>
                      </div>
                    </div>
                ...
                <div id="inf_director<?= $compt ?>" class="modal fade delete-modal" role="dialog">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-gradient-dark">
                      ...
                      <div class="modal-footer m-auto">
                        <button class="btn btn-secondary" type="button" data-dismiss="modal"><?php language_content("Fermer", "Close") ?></button>
                        <a class="btn btn-info" href="worker.php?page=controllers/worker/block_user_controller&User_Id=<?= $list['userId'] ?>&test=1"><?php language_content("Activer", "Activate") ?></a>
                      </div>
                    </div>
