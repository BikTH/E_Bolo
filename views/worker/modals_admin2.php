    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-gradient-dark">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="worker.php?page=controllers/users/logout_controller&close_session=1"><?php language_content("Déconnexion", "Logout") ?></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-gradient-dark">
            ...
            <div class="modal-footer m-auto">
                <button class="btn btn-secondary" type="button" data-dismiss="modal"><?php language_content("Annuler", "Cancel") ?></button>
                <a class="btn btn-danger" href="worker.php?page=controllers/worker/employees/bann_employee_controller&user_id=<?= $list["userId"] ?>"><?php language_content("Supprimer", "Delete") ?></a>
            </div>
        </div>
...
<div id="delete_template" class="modal fade delete-modal" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-gradient-dark">
            ...
            <div class="modal-footer m-auto">
                <button class="btn btn-secondary" type="button" data-dismiss="modal"><?php language_content("Annuler", "Cancel") ?></button>
                <a class="btn btn-danger" href="worker.php?page=controllers/worker/right_of_access/delete_access_controller&access_id=<?php if(isset($list["access_id"])): ?><?= $list["access_id"] ?><?php endif; ?>"><?php language_content("Supprimer", "Delete") ?></a>
            </div>
        </div>
