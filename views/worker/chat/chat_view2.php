        ...
        <div class="col-md-4 col-xl-3 chat">
            <div class="card mb-sm-3 mb-md-0 contacts_card bg-transparent">
                <div class="card-header bg-gradient-dark text-center">
                    <div>
                        <a href="worker.php?page=controllers/worker/chat/create_chat_controller2" class="btn-outline-dark text-light btn-block rounded "> <i class="fa fa-plus-circle"></i> <?= language_content("Nouveau Groupe", "New group") ?> </a>
                    </div>
                ...
                <div class="card-body contacts_body">
                    <ui class="contacts">
                        ...
                        ?>
                                <li class="">
                                    <a href="worker.php?page=controllers/worker/chat/message-detail-controller2&user_id=<?= $user['userId'] ?>" class="text-light ">
            ...
            <div class="col-md-8 col-xl-6 chat">
                <div class="card bg-transparent shadow ">
                                        ...
                                        <div class="msg_cotainer text-light">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-8">
                                                            <a class="btn btn-outline-success" href="worker.php?page=controllers/worker/chat/save_msg_file_controller2&user_id=<?= $user_detail["userId"] ?>&file_id=<?= $info2["fileId"] ?>">
                    ...
                    <div class="card-footer bg-gradient-dark">
                        ...
                        <form method="post" action="worker.php?page=controllers/worker/chat/add-message-controller2">
                            <div class="input-group">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr class="text-light">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <a href="worker.php?page=controllers/worker/chat/send_file_controller2&fileid=<?= $file["fileId"] ?>&userid=<?= $user_detail['userId'] ?>" class="btn btn-primary btn-sm">
            ...
            <?php if (isset($new_conversation1)) : ?>
                <div class="col-md-8 col-xl-6 chat">
                    <div class="card rounded bg-transparent border-0">
                        <form enctype="multipart/form-data" method="post" action="worker.php?page=controllers/worker/chat/create_chat_controller2" class="needs-validation m-4" novalidate>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="text-light">
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-outiline-info btn-sm" href="worker.php?page=controllers/worker/chat/create_chat_controller2&group_id=<?= $groupId?>&userid=<?= $user2["userId"] ?>">
