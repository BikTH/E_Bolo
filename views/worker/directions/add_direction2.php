                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="text-light">
                                    ...
                                    <td class="text-center">
                                    <a href="worker.php?page=controllers/worker/directions/add_direction_controller&add_employee&direction=<?=$direction_id?>&employee=<?= $list["userId"]?>" class="btn btn-success col-md-4"><i class="fas fa-fw fa-plus-circle"></i><?php language_content(" Ajouter", " Add") ?></button>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
