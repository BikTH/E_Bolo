    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col-6 row justify-content-end">
                <?php if ($test["d3"] == 1) : ?>
                    <a href="worker.php?page=views/worker/directions/add_direction" class="btn btn-info btn-sm float-right"><i class="fas fa-fw fa-plus-circle"></i><?php language_content("Ajouter une direction", "Add Direction") ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
                    ...
                    ?>
                        <tr class="text-light">
                            ...
                            <td class="text-center">
                                <div class="">
                                    <?php if ($test["d1"] == 1) : ?>
                                        <a href="worker.php?page=controllers/worker/directions/direction_details_controller&direction_id=<?= $list['directionId'] ?>" class="btn btn-info btn-sm"> <i class="fas fa-fw fa-eye"></i></a>
                                    <?php endif; ?>
                                    <?php if ($test["d2"] == 1) : ?>
                                        <a href="worker.php?page=controllers/worker/directions/direction_edit_controller&direction_id=<?= $list['directionId'] ?>" class="btn btn-success btn-sm "> <i class="fas fa-fw fa-pen"></i> </a>
                                    <?php endif; ?>
                                    <?php if ($test["d4"] == 1) : ?>
