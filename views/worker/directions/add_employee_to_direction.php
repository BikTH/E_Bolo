                    ...
                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tfoot>
                            <tr class="text-center">
                                <td colspan="4">
                                    <a class="btn btn-secondary text-light col-md-4" href="worker.php?page=views/worker/directions/list_directions"><?php language_content("Terminer ", "Close ") ?><i class="fas fa-fw fa-arrow-circle-right"></i></a>
                                </td>
                            </tr>
                        </tfoot>
                        <tbody>
                            ...
                            ?>
                                <tr class="text-light">
                                    ...
                                    <td class="text-center">
                                        <a href="worker.php?page=controllers/worker/directions/add_employee_to_direction_controller&add_employee&direction=<?= $direction_id ?>&employee=<?= $list["userId"] ?>" class="btn btn-success col-md-4"><i class="fas fa-fw fa-plus-circle"></i><?php language_content(" Ajouter", " Add") ?></button>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
