...
<div class="row justify-content-center py-4 mx-0">
    ...
    <div class=" offset-1 col-10">
        <div class="card card-body bg-transparent border-0  shadow-sm">
            <form enctype="multipart/form-data" method="post" action="worker.php?page=controllers/worker/directions/add_direction_controller" class="needs-validation" novalidate>
                ...
                <div class="row mb-4">
                    ...
                    <div class="input-group col-3 text-center ">
                        <a class=" btn-secondary btn-block rounded text-decoration-none" href="worker.php?page=views/worker/directions/add_direction_11"> <?php language_content("Créer un nouveau Modèle", "Create a new template") ?> </a>
                    </div>
