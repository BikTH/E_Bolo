    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-primary bg-transparent border-0 shadow h-100 py-2">
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <a class="btn btn-outline-primary float-right" href="worker.php?page=views/worker/employees/list_employee"><?= language_content("Détails", "Details") ?></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success bg-transparent border-0  shadow h-100 py-2">
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <a class="btn btn-outline-success float-right" href="worker.php?page=views/worker/company_files/list_files"><?= language_content("Détails", "Details") ?></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning bg-transparent border-0 shadow h-100 py-2">
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <a class="btn btn-outline-warning float-right" href="worker.php?page=views/worker/directions/list_directions"><?= language_content("Détails","Details")?></a>
                </div>
            </div>
        </div>
    </div>
