...
<ul class="navbar-nav  bg-dark sidebar sidebar-dark accordion text-light" id="accordionSidebar">
    ...
    <div class="collapse " id="collapseExample">
        ...
        <!-- Nav Item - View Files -->
        <li class="nav-item">
            <a class="nav-link" href="worker.php?page=views/worker/files_worker/list_files">
        ...
        <li class="nav-item text-light">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-gradient-dark py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item text-light" href="worker.php?page=views/worker/files_worker/upload_files">
                        <i class="fas fa-fw fa-upload"></i>
                        <?php language_content("Mettre en ligne", "Upload") ?>
                    </a>
                    <a class="collapse-item text-light" href="worker.php?page=views\worker\files_worker\download_files">
        ...
        <!-- <li class="nav-item text-light">
            ...
            <div id="collapseTw" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-gradient-dark py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item text-light" href="worker.php?page=views/worker/chat/chat_views3">
        ...
        <li class="nav-item text-light">
            ...
            <div id="collapseTwos" class="collapse" aria-labelledby="headingTwos" data-parent="#accordionSidebar">
                <div class="bg-gradient-dark py-2 collapse-inner rounded">
                    <h6 class="collapse-header text-light"><?php language_content("Charger des fichiers :", "Load Files :") ?></h6>
                    <a class="collapse-item text-light" href="worker.php?page=views/worker/chat/chat_view1">
                    ...
                    <a class="collapse-item text-light" href="worker.php?page=views/worker/chat/chat_view2">
                        <i class="fas fa-fw fa-comments"></i>
        ...
        <li class="nav-item text-light">
            ...
            <!-- Messages -->
            <!-- <a class="nav-link" href="worker.php?page=views/worker/chat/chat_view1">
                <i class="fas fa-fw fa-comments"></i>
        ...
        <li class="nav-item text-light">
            <!-- Consult my position -->
            <a class="nav-link" href="worker.php?page=views/worker/geolocalisation">
    ...
    <!-- <li class="nav-item">
        <a class="nav-link" href="worker.php?page=views/worker/my_direction">
    ...
    <?php if ($test["non1"] == 1 || $test["non2"] == 1 || $test["non3"] == 1 || $test["non4"] == 1 || $test["non5"] == 1) : ?>
        ...
        <div class="collapse " id="collapseExampl">
            ...
            <!-- Nav Item - Stat Admin -->
            <!-- <li class="nav-item">
                <a class="nav-link" href="worker.php?views/worker/home_worker">
            ...
            <?php if ($test["non1"] == 1) : ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="worker.php?page=views/worker/activate_user">
                ...
                <li class="nav-item text-light">
                    ...
                    <div id="collapseT7" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-gradient-dark py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item text-light" href="worker.php?page=views/worker/directions/list_directions">
                                <i class="fas fa-fw fa-list"></i>
                                <?php language_content("Liste des Directions", "List of directions") ?>
                            </a>
                            <?php if ($test["d3"] == 1) : ?>
                                <a class="collapse-item text-light" href="worker.php?page=views/worker/directions/add_direction">
                ...
                <li class="nav-item text-light">
                    ...
                    <div id="collapseT777" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-gradient-dark py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item text-light" href="worker.php?page=views/worker/employees/list_employee">
                                <i class="fas fa-fw fa-list"></i>
                                <?php language_content("Liste employés", "List of employees") ?>
                            </a>
                            <?php if ($test["e3"] == 1) : ?>
                                <a class="collapse-item text-light" href="worker.php?page=views/worker/employees/add_employee">
                                    <i class="fas fa-fw fa-plus-circle"></i>
                ...
                <li class="nav-item text-light">
                    ...
                    <div id="collapseT77" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-gradient-dark py-2 collapse-inner rounded">
                            ...
                            <!-- <a class="collapse-item text-light" href="worker.php?page=views/worker/company_files/folder">
                                <i class="fas fa-fw fa-folder"></i>
                                <?php language_content("Dossier", "Folder") ?>
                            </a> -->
                            <a class="collapse-item text-light" href="worker.php?page=views/worker/company_files/list_files">
                                <i class="fas fa-fw fa-file-archive"> </i>
                                <?php language_content("Liste de fichiers", "List of Files") ?>
                            </a>
                            <?php if ($test["f3"] == 1) : ?>
                                <a class="collapse-item text-light" href="worker.php?page=views/worker/company_files/add_file">
                                    <i class="fas fa-fw fa-plus-circle"> </i>
                ...
                <li class="nav-item text-light">
                    ...
                    <div id="collapseT778" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-gradient-dark py-2 collapse-inner rounded">
                            ...
                            <?php if ($test["a3"] == 1) : ?>
                                <a class="collapse-item text-light" href="worker.php?page=views/worker/right_of_access/create_template">
                                    <i class="fas fa-fw fa-pen"></i>
                                    <?php language_content("Créer un modèle", "Create a template") ?>
                                </a>
                            <?php endif; ?>
                            <a class="collapse-item text-light" href="worker.php?page=views/worker/right_of_access/list_of_access">
    ...
    <li class="nav-item">
        <a class="nav-link" href="worker.php?page=views/worker/suggestion">
