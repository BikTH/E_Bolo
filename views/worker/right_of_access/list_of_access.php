    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col-6 row justify-content-end">
                ...
                <!-- <a href="worker.php?out=I" class="btn btn-info btn-sm float-right"> <i class="fas fa-plus-circle"></i><?= language_content(" Créer un nouveau Modèle", " Create a new template") ?></a> -->

                <a href="worker.php?page=views/worker/right_of_access/create_template" class="btn btn-info btn-sm float-right"> <i class="fas fa-plus-circle"></i><?= language_content(" Créer un nouveau Modèle", " Create a new template") ?></a>
            </div>
        </div>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="text-light">
                            ...
                            <td class="text-center">
                                <?php if ($test["a1"] == 1) : ?>
                                    <a href="worker.php?page=controllers/worker/right_of_access/details_of_access_controller&access_id=<?= $list["access_id"] ?>" class="btn btn-outline-info btn-sm"><i class="fas fa-eye"></i></a>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <div class="row">
                                    <div class="col-6">
                                        <?php if ($test["a2"] == 1) : ?>
                                            <a class=" btn rounded-circle" href="worker.php?page=controllers/worker/right_of_access/edit_access_controller&access_id1=<?= $list["access_id"] ?>"> <i class="fas fa-pen text-light"></i> </a>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-6">
                                        <?php if ($test["a4"] == 1) : ?>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content bg-gradient-dark">
                                    ...
                                    <div class="modal-footer m-auto">
                                        ...
                                        <a class="btn btn-danger" href="worker.php?page=controllers/worker/right_of_access/delete_access_controller&access_id=<?= $list["access_id"] ?>"><?php language_content("Supprimer", "Delete") ?></a>
                                    </div>
                                </div>
