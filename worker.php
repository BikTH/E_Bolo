...
<body class="body2 text-info" id="top_page">

    <div id="wrapper">

        <?php include('views/worker/sidebar_worker.php'); ?>

        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content" class="body2 text-info">

                <!-- Topbar -->
                <!-- navbar de la page  -->
                <?php include('views/navbar/navbar_worker.php') ?>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid ">
                    ...
                    if (isset($_REQUEST["page"])) {
                        ...
                        include('views\worker\files_worker\list_files.php');
                    }
                    ?>
                </div>
            </div>
